...
var RTValueType$1 = /*#__PURE__*/Object.freeze({
  default: RTValueType,
  __moduleExports: RTValueType,
  VOID: RTValueType_1,
  VALUE: RTValueType_2,
  BOOLEAN: RTValueType_3,
  INT8: RTValueType_4,
  UINT8: RTValueType_5,
  INT32: RTValueType_6,
  UINT32: RTValueType_7,
  INT64: RTValueType_8,
  UINT64: RTValueType_9,
  FLOAT: RTValueType_10,
  DOUBLE: RTValueType_11,
  STRING: RTValueType_12,
  OBJECT: RTValueType_13,
  FUNCTION: RTValueType_14,
  VOIDPTR: RTValueType_15
});
...
var helper$1 = /*#__PURE__*/Object.freeze({
  default: helper,
  __moduleExports: helper,
  getRandomUUID: helper_1,
  getStatusStringByCode: helper_2,
  setProperty: helper_3,
  getTypeStringByType: helper_4,
  getProperty: helper_5,
  checkAndDumpObject: helper_6,
  isBigNumber: helper_7,
  invokeMethod: helper_8,
  updateListenerForRTFuction: helper_9,
  URLParser: helper_10
});
...
var RTException$1 = /*#__PURE__*/Object.freeze({
  default: RTException_1,
  __moduleExports: RTException_1
});
...
var RTValueHelper$1 = /*#__PURE__*/Object.freeze({
  default: RTValueHelper,
  __moduleExports: RTValueHelper,
  create: RTValueHelper_1
});
...
function fromBuffer(messageBuffer) {
  const messageObj = jsonBigint.parse(messageBuffer.toString(RTConst.DEFAULT_CHARSET));
...
var RTRemoteMulticastResolver$1 = /*#__PURE__*/Object.freeze({
  default: RTRemoteMulticastResolver_1,
  __moduleExports: RTRemoteMulticastResolver_1
});
  ...
  open() {
    return new Promise((resolve, reject) => {
      ...
      this.socket = net.connect(transport.port, transport.host, () => {
        logger_1.info(`new tcp connection to ${transport.host}:${transport.port}`);
        resolve(transport);
      });
...
function createTCPClientConnection(host, port) {
  const transport = new RTRemoteTCPTransport_1(host, port);
...
var RTRemoteClientConnection_2 = RTRemoteClientConnection_1.createTCPClientConnection;
...
function getObjectProxy(uri) {
  ...
  return createConnectionFromSpec(url$$1).then((connection) => {
 ...
 * @return {Promise<RTRemoteClientConnection>} the promise with connection
 */
function createConnectionFromSpec(url$$1) {
  let connection = null;
  const schema = url$$1.protocol.substr(0, url$$1.protocol.length - 1);
  logger_1.info(`start connection ${url$$1}`);
  switch (schema) {
    case 'tcp':
      connection = RTRemoteClientConnection_1.createTCPClientConnection(url$$1.hostname, url$$1.port);
      break;
    default:
...
var RTRemoteConnectionManager$1 = /*#__PURE__*/Object.freeze({
  default: RTRemoteConnectionManager,
  __moduleExports: RTRemoteConnectionManager,
  getObjectProxy: RTRemoteConnectionManager_1
});
...
var RTRemoteProxy$1 = /*#__PURE__*/Object.freeze({
  default: RTRemoteProxy_1,
  __moduleExports: RTRemoteProxy_1
});
