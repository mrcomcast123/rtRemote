 ...
 */
 newLocateRequest(objectId, replyTo) {
  const locateObj = {};
 ...
 */
 newLocateResponse(endpoint, objectId, senderId, correlationKey) {
  const response = {};
 ...
 */
 newSetRequest(objectId, propName, rtValue) {
  const setRequestObj = {};
 ...
 */
 newGetRequest(objectId, propName) {
  const getRequestObj = {};
 ...
 */
 newCallMethodRequest(objectId, methodName, ...args) {
 ...
 */
 newCallResponse(correlationKey, returnValue, statusCode) {
 ...
 */
 newKeepAliveResponse(correlationKey, statusCode) {
 ...
 */
 newSetPropertyResponse(correlationKey, statusCode, objectId) {
  const setResponse = {};
 ...
 * @return {object} the response message
 */
 newGetPropertyResponse(correlationKey, statusCode, objectId, value) {
  const getResponse = {};
 ...
 * @return {object} the response message
 */
 newOpenSessionResponse(correlationKey, objectId) {
  const response = {};
...
var RTMessageHelper = new CRTMessageHelper;
