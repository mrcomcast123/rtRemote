...
{
  uuidIndex++;
  return "4da67b13-d6ea-4ad8-855b-d7656fcc593f:"+uuidIndex;
}
 ...
 */
getStatusStringByCode(statusCode) {
 ...
 */
checkAndDumpObject(objectName, object) {
 ...
 */
updateListenerForRTFuction(protocol, rtFunction) {
 ...
 */
setProperty(object, requestMessage) {
 ...
 */
getProperty(object, getRequest, server) {
 ...
 */
invokeMethod(object, callRequest) {
